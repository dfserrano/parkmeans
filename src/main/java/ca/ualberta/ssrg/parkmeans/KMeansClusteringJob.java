...
public class KMeansClusteringJob {
	...
	public static void main(String[] args) throws IOException,
		...
		final SequenceFile.Writer centerWriter = SequenceFile.createWriter(
				conf, SequenceFile.Writer.file(center),
				SequenceFile.Writer.keyClass(ClusterCenter.class),
		...
		final SequenceFile.Writer dataWriter = SequenceFile.createWriter(conf,
				SequenceFile.Writer.file(in),
				SequenceFile.Writer.keyClass(ClusterCenter.class),
				SequenceFile.Writer.valueClass(Vector.class));
		dataWriter
